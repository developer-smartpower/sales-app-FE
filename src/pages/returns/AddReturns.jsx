...
const AddReturns = () => {
  ...
  const getReturnDetails_ = async () => {
    try {
      const response = await returnsService.getReturnDetails(return_id);
  ...
  const onSubmitPressed = async () => {
    try {
      const response = await returnsService.addReturns(formData);
  ...
  return (
    <ComponentWrapper
      navigationHeaderTitle="Add New Return"
